...
sinput bool default_TF4= true;                       // TF4 default visible;
...
sinput string objectPreamble ="RsiOma_mtf_";             // Objects unique id
sinput double alertlevel = 50.0;
...
double tf_1_previous, tf_1_preprevious;
double tf_2_previous, tf_2_preprevious;
double tf_3_previous, tf_3_preprevious;
double tf_4_previous, tf_4_preprevious;
...
int OnInit()
  {
   ...
   if (timeFrame_1 == PERIOD_M15)
   {
      tf_M15 = true;
   }
   if (timeFrame_1 == PERIOD_H1)
   {
      tf_H1 = true;
   }
   if (timeFrame_2 == PERIOD_M15)
   {
      tf_M15 = true;
   }
   if (timeFrame_2 == PERIOD_H1)
   {
      tf_H1 = true;
   }
   if (timeFrame_3 == PERIOD_M15)
   {
      tf_M15 = true;
   }
   if (timeFrame_3 == PERIOD_H1)
   {
      tf_H1 = true;
   }
   if (timeFrame_4 == PERIOD_M15)
   {
      tf_M15 = true;
   }
   if (timeFrame_4 == PERIOD_H1)
   {
      tf_H1 = true;
   }
...
void rsiomaCalculate()
{
   ...
   for(i = 0, y = 0; i < limit;i++)
   {
      ...
      ExtMapBuffer1[i] = iCustom(Symbol(), timeFrame_1, "Rsioma Light", 0, y);
      
      if (y == 1)
      {
         tf_1_previous = iCustom(Symbol(), timeFrame_1, "Rsioma Light", 0, y);
      }
      if (y == 2)
      {
         tf_1_preprevious = iCustom(Symbol(), timeFrame_1, "Rsioma Light", 0, y);
      }
   }
   ...
   {
      if (Time[i] < TimeArray[y]) y++;
      ExtMapBuffer2[i] = iCustom(Symbol(), timeFrame_2, "Rsioma Light", 0, y);
      
      if (y == 1)
      {
         tf_2_previous = iCustom(Symbol(), timeFrame_2, "Rsioma Light", 0, y);
      }
      if (y == 2)
      {
         tf_2_preprevious = iCustom(Symbol(), timeFrame_2, "Rsioma Light", 0, y);
      }
   ...
   {
      if (Time[i] < TimeArray[y]) y++;
      ExtMapBuffer3[i] = iCustom(Symbol(), timeFrame_3, "Rsioma Light", 0, y);
      
      if (y == 1)
      {
         tf_3_previous = iCustom(Symbol(), timeFrame_3, "Rsioma Light", 0, y);
      }
      if (y == 2)
      {
         tf_3_preprevious = iCustom(Symbol(), timeFrame_3, "Rsioma Light", 0, y);
      }
   }
   ...
   {
      if (Time[i] < TimeArray[y]) y++;
      ExtMapBuffer4[i] = iCustom(Symbol(), timeFrame_4, "Rsioma Light", 0, y);
      
      if (y == 1)
      {
         tf_4_previous = iCustom(Symbol(), timeFrame_4, "Rsioma Light", 0, y);
      }
      if (y == 2)
      {
         tf_4_preprevious = iCustom(Symbol(), timeFrame_4, "Rsioma Light", 0, y);
      }
   }
