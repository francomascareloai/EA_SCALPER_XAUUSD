...
extern bool   DiLockProfit = false;
...
extern bool   Modify_TPSL = false;  //Bila false maka TP_in_Money juga tidak berfungsi
extern double TP_in_Money  = 0.40;
string gsa_88[4];
int ticket=0; 
int a=0;
         ...
         if (OrderSymbol() == Symbol()) {
            if (OrderType() == OP_BUY) {
               if (OrderStopLoss() == 0.0 && OrderTakeProfit() == 0.0) {
                  if (OrderModify(OrderTicket(), OrderOpenPrice(), OrderOpenPrice() - StopLoss * Point, OrderOpenPrice() + TakeProfit * Point, 0) == TRUE) gsa_88[3] = "Put SL and TP at trade BUY no: #" + OrderTicket();
                  ...
                  if (DiLockProfit && Bid - OrderOpenPrice() > LockProfit * Point) {
                     if (OrderStopLoss() <= OrderOpenPrice()) {
                        ...
                        if (DiLockProfit && Bid - OrderStopLoss() > LockProfit * Point) OrderModify(OrderTicket(), OrderOpenPrice(), Bid - LockProfit * Point, OrderTakeProfit(), 0);
               ...
               if (OrderType() == OP_SELL) {
                  if (OrderStopLoss() == 0.0 && OrderTakeProfit() == 0.0) {
                     if (OrderModify(OrderTicket(), OrderOpenPrice(), OrderOpenPrice() + StopLoss * Point, OrderOpenPrice() - TakeProfit * Point, 0) == TRUE) gsa_88[3] = "Put SL and TP at trade SELL no: #" + OrderTicket();
                     ...
                     if (DiLockProfit && OrderOpenPrice() - Ask > LockProfit * Point) {
                        if (OrderStopLoss() >= OrderOpenPrice()) {
                           ...
                           if (DiLockProfit && OrderStopLoss() - Ask > LockProfit * Point) OrderModify(OrderTicket(), OrderOpenPrice(), Ask + LockProfit * Point, OrderTakeProfit(), 0);
      ...
      if (Digits == 2 || Digits == 3 || Digits == 5) {
         for (l_pos_8 = 0; l_pos_8 < OrdersTotal(); l_pos_8++) {
            ...
            if (OrderSymbol() == Symbol()) {
               if (OrderType() == OP_BUY) {
                  if (OrderStopLoss() == 0.0 && OrderTakeProfit() == 0.0) {
                     if (OrderModify(OrderTicket(), OrderOpenPrice(), OrderOpenPrice() - 10.0 * (StopLoss * Point), OrderOpenPrice() + 10.0 * (TakeProfit * Point), 0) == TRUE) gsa_88[3] = "Put SL and TP at trade BUY no: #" + OrderTicket();
                     else gsa_88[3] = "ERROR -- Put SL and TP at trade BUY no: #" + OrderTicket();
                     ObjectSet("ObjLabel4", OBJPROP_CORNER, 1);
                     ObjectSet("ObjLabel4", OBJPROP_XDISTANCE, 10);
                     ObjectSet("ObjLabel4", OBJPROP_YDISTANCE, 45);
                     ...
                     if (DiLockProfit && Bid - OrderOpenPrice() > 10.0 * (LockProfit * Point)) {
                        if (OrderStopLoss() <= OrderOpenPrice()) {
                           ...
                           if (DiLockProfit && Bid - OrderStopLoss() > 10.0 * (LockProfit * Point)) OrderModify(OrderTicket(), OrderOpenPrice(), Bid - 10.0 * (LockProfit * Point), OrderTakeProfit(), 0);
                           gsa_88[3] = "Trailing SL trade no: #" + OrderTicket();
                           ObjectSet("ObjLabel4", OBJPROP_CORNER, 1);
                           ObjectSet("ObjLabel4", OBJPROP_XDISTANCE, 10);
                           ObjectSet("ObjLabel4", OBJPROP_YDISTANCE, 45);
                  ...
                  if (OrderStopLoss() == 0.0 && OrderTakeProfit() == 0.0) {
                     if (OrderModify(OrderTicket(), OrderOpenPrice(), OrderOpenPrice() + 10.0 * (StopLoss * Point), OrderOpenPrice() - 10.0 * (TakeProfit * Point), 0) == TRUE) gsa_88[3] = "Put SL and TP at trade SELL no: #" + OrderTicket();
                     else gsa_88[3] = "ERROR -- Put SL and TP at trade SELL no: #" + OrderTicket();
                     ObjectSet("ObjLabel4", OBJPROP_CORNER, 1);
                     ObjectSet("ObjLabel4", OBJPROP_XDISTANCE, 10);
                     ObjectSet("ObjLabel4", OBJPROP_YDISTANCE, 45);
                     ...
                     if (DiLockProfit && OrderOpenPrice() - Ask > 10.0 * (LockProfit * Point)) {
                        if (OrderStopLoss() >= OrderOpenPrice()) {
                           ...
                           if (DiLockProfit &&OrderStopLoss() - Ask > 10.0 * (LockProfit * Point)) OrderModify(OrderTicket(), OrderOpenPrice(), Ask + 10.0 * (LockProfit * Point), OrderTakeProfit(), 0);
                           gsa_88[3] = "Trailing SL at trade no: #" + OrderTicket();
                           ObjectSet("ObjLabel4", OBJPROP_CORNER, 1);
                           ObjectSet("ObjLabel4", OBJPROP_XDISTANCE, 10);
                           ObjectSet("ObjLabel4", OBJPROP_YDISTANCE, 45);
