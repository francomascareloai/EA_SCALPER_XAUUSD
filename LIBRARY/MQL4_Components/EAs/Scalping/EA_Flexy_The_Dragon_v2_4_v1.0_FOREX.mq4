...
sinput string profit_lock2;                        // (locks profit, must be used!, 0.01 = 1%)
...
// button coordinates:
int btnLeftAxis = 250;                          // distance of 1st button from left
int btnTopAxis = 1;                             // distance of all buttons from top
int btnHeight = 24;                             // height of buttons
int btnGap = 2;                                 // gap between buttons
int btnWidth =100;                              // width of small buttons
