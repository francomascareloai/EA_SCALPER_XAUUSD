  ...
  /* if(OrdersPerSymbol<1)
     {
      if(bull>bear && RSINEG)
		  {
         OrderSend(Symbol(),OP_BUY,Lots,Ask,Slippage,slBUY,tpBUY,MAGIC,0,White);//"ZJMQCIDFG",11321
         return(0);
        }
      ...
      if(bull<bear && RSIPOS)
        {
         OrderSend(Symbol(),OP_SELL,Lots,Bid,Slippage,slSEL,MAGIC,tpSEL,0,Red);//"ZJMQCIDFG",11321,
         return(0);
        }
     } //if
