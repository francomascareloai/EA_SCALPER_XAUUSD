//+------------------------------------------------------------------+
//|                                             FXMIND SCALPANDO.mq4 |
//|                               Copyright 2020, JMAR EXPERTS PRO . |
//|                                                                  |                              \
//+------------------------------------------------------------------+
#property copyright "FXMIND"
#property link      "t.me/robotprofits"

#property description   "MARTI PRO SCALPER COMBINED HEDGE "
#property description   "FXMIND"
#property description   "GOLD SETTING H1 timeframe 1000$standard per 0.01lot starting"
...
extern string xFXMINDx = "t.me/robotprofits, +639485758802";
extern string LICENSED_TO = "=FXMIND Group ltd.=";
extern bool MARtiScalper = TRUE;
double Account = 123567;
extern string xxxxxxxxxxx = "35.176.119.134";
...
double Gd_636;
bool Gi_644;
string Gs_648 = "t.me/robotprofits";
int Gi_656 = 123;
int Gi_660;
int Gi_664 = 123;
double Gd_668;
...
double Gd_920;
bool Gi_928;
string Gs_932 = "FXMIND SCALPANDO";
int Gi_940 = 123;
int Gi_944;
int Gi_948 = 123;
double Gd_952;
...
int init() {
   ...
   G_text_1472 = "EL tarantados Marti  ,, .";
...
/*   if (!IsDemo())
   ...
   Comment("" 
      + "\n" 
      + "DEVELOPED BY JMAR EGONIA +639485758802" 
   ...
   ObjectSetText("1", "Scalpando Marti", 50, "Georgia", Blue);
   ...
   ObjectSetText("ObjLabel1", " O ", 50, "Georgia", Blue);
   ObjectSet("ObjLabel1", OBJPROP_CORNER, 3);
   ObjectSet("ObjLabel1", OBJPROP_XDISTANCE, 27);
   ObjectSet("ObjLabel1", OBJPROP_YDISTANCE, 3);
   ObjectCreate("ObjLabel2", OBJ_LABEL, 0, 0, 0);
   ObjectSetText("ObjLabel2", " P ", 50, "Georgia", Yellow);
   ...
   ObjectSetText("ObjLabel3", " R", 50, "Georgia", Red);
   ObjectSet("ObjLabel3", OBJPROP_CORNER, 3);
   ObjectSet("ObjLabel3", OBJPROP_XDISTANCE, 83);
   ObjectSet("ObjLabel3", OBJPROP_YDISTANCE, 19);
   ObjectCreate("ObjLabel4", OBJ_LABEL, 0, 0, 0);
   ObjectSetText("ObjLabel4", "Philippines Forex Trader", 8, "System", LimeGreen);
   ObjectSet("ObjLabel4", OBJPROP_CORNER, 3);
   ObjectSet("ObjLabel4", OBJPROP_XDISTANCE, 163);
   ObjectSet("ObjLabel4", OBJPROP_YDISTANCE, 45);
   ObjectCreate("ObjLabel5", OBJ_LABEL, 0, 0, 0);
   ObjectSetText("ObjLabel5", "t.me/robotprofits", 18, "Sitka Banner", Aqua);
   ObjectSet("ObjLabel5", OBJPROP_CORNER, 3);
   ObjectSet("ObjLabel5", OBJPROP_XDISTANCE, 328);
   ObjectSet("ObjLabel5", OBJPROP_YDISTANCE, 40);
   ObjectCreate("ObjLabel6", OBJ_LABEL, 0, 0, 0);
   ObjectSetText("ObjLabel6", "FXMIND Group ltd.", 28, "Georgia", SkyBlue);
   ObjectSet("ObjLabel6", OBJPROP_CORNER, 3);
   ObjectSet("ObjLabel6", OBJPROP_XDISTANCE, 162);
   ObjectSet("ObjLabel6", OBJPROP_YDISTANCE, 0);
