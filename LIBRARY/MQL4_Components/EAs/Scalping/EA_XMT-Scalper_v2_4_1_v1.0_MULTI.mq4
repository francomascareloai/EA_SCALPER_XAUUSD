...
extern string OrderCmt = "XMT-Scalper 2.4.1";// Trade comments that appears in the Trade and Account History tab
...
string ea_version = "XMT-Scalper v. 2.4.1";
...
void sub_printdetails()
{
	...
	Print ("Broker stoplevel / freezelevel (max): ", stoplevel," points.");	
