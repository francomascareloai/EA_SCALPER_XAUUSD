...
double gd_288;
bool gi_296;
string gs_300 = "Robot Forex 2015 ";
int g_time_308 = 0;
int gi_312;
int gi_316 = 0;
double gd_320;
...
int start() {
   ...
   if (gi_176) TrailingAlls(gd_136, gd_144, g_price_240);
   if (gi_180) {
   ...
   if (gi_164) {
      if (ld_20 < 0.0 && MathAbs(ld_20) > gd_168 / 100.0 * AccountEquityHigh()) {
         CloseThisSymbolAll();
   ...
   if (gi_344) {
      ...
      if (gi_352) {
         if (gi_80 || ls_12 == "true") {
            ...
            gd_320 = NormalizeDouble(gd_88 * l_ord_lots_36, gd_112);
         } else gd_320 = fGetLots(OP_SELL);
         if (gi_84 && ls_4 == "true") {
            gi_316 = gi_332;
            if (gd_320 > 0.0) {
               RefreshRates();
               gi_356 = OpenPendingOrder(1, gd_320, Bid, g_slippage_96, Ask, 0, 0, gs_300 + "-" + gi_316, g_magic_204, 0, HotPink);
               if (gi_356 < 0) {
         ...
         if (gi_348) {
            if (gi_80 || ls_12 == "true") {
               ...
               gd_320 = NormalizeDouble(gd_88 * l_ord_lots_28, gd_112);
            } else gd_320 = fGetLots(OP_BUY);
            if (gi_84 && ls_4 == "true") {
               gi_316 = gi_332;
               if (gd_320 > 0.0) {
                  gi_356 = OpenPendingOrder(0, gd_320, Ask, g_slippage_96, Bid, 0, 0, gs_300 + "-" + gi_316, g_magic_204, 0, Lime);
                  if (gi_356 < 0) {
                     Print("Error: ", GetLastError());
                     return (0);
                  }
   ...
   if (gi_344 && gi_332 < 1) {
      ...
      if (!gi_352 && !gi_348 && ls_4 == "true") {
         ...
         if (l_iclose_44 > l_iclose_52) {
            ...
            if (gd_320 > 0.0) {
               gi_356 = OpenPendingOrder(1, gd_320, g_bid_248, g_slippage_96, g_bid_248, 0, 0, gs_300 + "-" + gi_316, g_magic_204, 0, HotPink);
               if (gi_356 < 0) {
            ...
            if (gd_320 > 0.0) {
               gi_356 = OpenPendingOrder(0, gd_320, g_ask_256, g_slippage_96, g_ask_256, 0, 0, gs_300 + "-" + gi_316, g_magic_204, 0, Lime);
               if (gi_356 < 0) {
                  Print(gd_320, "Error: ", GetLastError());
                  return (0);
               }
      ...
      if (gi_356 > 0) gi_312 = TimeCurrent() + 60.0 * (60.0 * gd_184);
      gi_344 = FALSE;
   }
   gi_332 = CountTrades();
   g_price_240 = 0;
...
double fGetLots(int a_cmd_0) {
   ...
   case 0:
      ...
      break;
   case 1:
      l_lots_4 = NormalizeDouble(Lots * MathPow(gd_88, gi_316), gd_112);
      break;
   case 2:
      l_datetime_16 = 0;
      l_lots_4 = Lots;
