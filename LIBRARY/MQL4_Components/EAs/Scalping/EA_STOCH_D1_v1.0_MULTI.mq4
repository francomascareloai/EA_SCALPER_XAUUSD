...
int start()
{
  ...
  {
     int result=0;
     if((iStochastic(NULL,0,14,3,3,MODE_SMA,1,MODE_SIGNAL,1)<20)&&(iStochastic(NULL,0,14,3,3,MODE_SMA,1,MODE_SIGNAL,0)>20)) // Here is your open buy rule
     {
     ...
     if((iStochastic(NULL,0,14,3,3,MODE_SMA,1,MODE_SIGNAL,1)>80)&&(iStochastic(NULL,0,14,3,3,MODE_SMA,1,MODE_SIGNAL,0)<80)) // Here is your open Sell rule
     {
