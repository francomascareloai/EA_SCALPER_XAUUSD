...
/*   SSP=BSSL;  
 ...
 if (dir==-1)
  {
   SSP=iLow(Symbol(),0,x1)-Filtr*Point;  
...
/*   BSP=SSSL;
 ...
 if (buy) OrderSend(Symbol(), OP_BUYSTOP, Lots, BSP, 3, BSSL, BSTP, "", magic, 0, Green);
 if (sell) OrderSend(Symbol(), OP_SELLSTOP, Lots, SSP, 3, SSSL, SSTP, "", magic, 0, Red);
