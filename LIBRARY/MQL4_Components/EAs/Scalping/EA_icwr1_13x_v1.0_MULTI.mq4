...
//---current fibo extention if no retracement
   ...
   if(a.high.shift<a.low.shift)  {         
      if(shift>1 && high.r>0 && Low[Lowest(Symbol(),Period(),MODE_LOW,shift,0)]>high.r) {
   ...
   if(a.low.shift<a.high.shift)  {      
      if(shift>1 && low.r>0 && High[Highest(Symbol(),Period(),MODE_HIGH,shift,0)]<low.r)   {
