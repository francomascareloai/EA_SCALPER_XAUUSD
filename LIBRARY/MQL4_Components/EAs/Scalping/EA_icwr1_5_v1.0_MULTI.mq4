...
//---bullish (uptrend) fibo
   if(a.high.shift<=a.low.shift)  {
      ...
      ObjectSet(FiboName, OBJPROP_FIRSTLEVEL+0, 0.25);  ObjectSetFiboDescription(FiboName, "Lower Confirmation Level 25.0%", 0);
      ObjectSet(FiboName, OBJPROP_FIRSTLEVEL+1, 0.382); ObjectSetFiboDescription(FiboName, "Lower Retracement Level 38.2%", 1);
      ObjectSet(FiboName, OBJPROP_FIRSTLEVEL+2, 0.618); ObjectSetFiboDescription(FiboName, "Upper Retracement Level 61.8%", 2);
      ObjectSet(FiboName, OBJPROP_FIRSTLEVEL+3, 0.75);  ObjectSetFiboDescription(FiboName, "Upper Confirmation Level 75.0%", 3);
