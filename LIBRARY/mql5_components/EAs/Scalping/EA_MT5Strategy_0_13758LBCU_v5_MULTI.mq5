...
//| Strategy 0.13758 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (netted)
//|    Generated at 12/10/2024 02:03
//| 
//|    Backtested on XAUUSDGOLD / M15, 2022.10.01 - 2024.10.16 
//+------------------------------------------------------------------+
...
input string CustomComment = "MT5Strategy_0_13758LBCU";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 98624;        //MagicNumber
...
input int ExitAfterBars1 = 231;        //ExitAfterBars1
input double MoveSL2BECoef1 = 4.2;        //MoveSL2BECoef1
input double SL2BEAddPipsCoef1 = 3.3;        //SL2BEAddPipsCoef1
input double StopLoss1 = 401;        //StopLoss1
input double TrailingStop1 = 404;        //TrailingStop1
...
#define ATR_1 0     //iCustom(NULL, 0, "SqATR", 82)
#define ATR_2 1     //iCustom(NULL, 0, "SqATR", 62)
...
string sqStrategyName = "Strategy 0.13758";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (NormalizeDouble((double) SessionOpen(NULL,0, 5, 51, 1), 6) >= NormalizeDouble((double) sqLow(NULL,0, 2), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(SessionClose(NULL,0, 19, 20, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetSL2BEAddPips(_ticket, "SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_2, 1)");
...
bool initIndicators(){
   ...
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 82);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 62);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_2, 1));
   }
