...
//|    Generated at 12/10/2024 02:09
//| 
//|    Backtested on XAUUSDGOLD / M30, 2017.10.01 - 2024.10.16 
//+------------------------------------------------------------------+
...
input string CustomComment = "MT5M30XAUUSDLBCU";
...
input int StdDevRisingPeriod1 = 50;        //StdDevRisingPeriod1
input double MoveSL2BECoef1 = 4.3;        //MoveSL2BECoef1
input double StopLossCoef1 = 4.2;        //StopLossCoef1
input double TrailingStopCoef1 = 4.5;        //TrailingStopCoef1
...
#define STDDEV_1 0     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_HIGH)
#define STDDEV_2 1     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_LOW)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 72)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 20)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 32)
...
string sqStrategyName = "Strategy 0.22836";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsRising(STDDEV_1, 2, false, 0);

     ShortEntrySignal = sqIsRising(STDDEV_2, 2, false, 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqWeekly(NULL,0, "Open", 0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 36);

         //Check StopLoss & ProfitTarget
         //sqCheckSLPT(_ticket, sl, pt);
         // MoveSL2BE initialization
         sqSetMoveSL2BE(_ticket, "MoveSL2BECoef1 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
...
bool initIndicators(){
   ...
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_2] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 72);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 32);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("MoveSL2BECoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (MoveSL2BECoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
