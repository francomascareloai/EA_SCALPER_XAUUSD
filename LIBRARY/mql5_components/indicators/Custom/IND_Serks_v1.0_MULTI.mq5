...
//---
      if(rates_total>prev_calculated)
     {
      ...
      for(int i=bars; i>=0; i--)
        {
         int p1=(int)MathRound(price[i+1]/_Point),
             p2=(int)MathRound(price[i+2]/_Point),
             p3=(int)MathRound(price[i+3]/_Point),
             p4=(int)MathRound(price[i+4]/_Point),
             p0s1=(int)MathRound(price[i+Shift]/_Point),
             p0s2=(int)MathRound(price[i+2*Shift]/_Point),
             p1s1=(int)MathRound(price[i+Shift+1]/_Point),
             p1s2=(int)MathRound(price[i+2*Shift+1]/_Point),
             p2s1=(int)MathRound(price[i+Shift+2]/_Point),
             p2s2=(int)MathRound(price[i+2*Shift+2]/_Point),
             p3s1=(int)MathRound(price[i+Shift+3]/_Point),
             p3s2=(int)MathRound(price[i+2*Shift+3]/_Point),
             p4s1=(int)MathRound(price[i+Shift+4]/_Point),
             p4s2=(int)MathRound(price[i+2*Shift+4]/_Point),
