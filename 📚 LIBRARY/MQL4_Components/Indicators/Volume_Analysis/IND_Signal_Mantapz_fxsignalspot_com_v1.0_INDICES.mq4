...
//+--------- TRO MODIFICATION ---------------------------------------+ 
 ...
 bool   Sound.Alert    = false ;
 bool   Show.PriceBox  = false;
 int    myBoxWidth     = 3;
