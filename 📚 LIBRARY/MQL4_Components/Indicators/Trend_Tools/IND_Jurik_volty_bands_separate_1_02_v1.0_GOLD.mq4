...
int start()
{
   ...
   for (i=limit;i>=0;i--)
   {
      int y = iBarShift(NULL,timeFrame,Time[i]);
         upValues[i] = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,0,y);
         dnValues[i] = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,1,y);
         prc[i]      = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,3,y);
         ma[i]       = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,4,y);
         trend[i]    = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,5,y);
         manageArrow(i);
         if (ShowMiddle)
            miValues[i] = iCustom(NULL,timeFrame,indicatorFileName,"calculateValue",Length,Price,Shift,MaPeriod,MaMethod,ShowMiddle,ZeroBind,Normalize,alertsOnZeroCross,alertsOnAllBreakOuts,alertsOnAllBreakOutBars,2,y);
