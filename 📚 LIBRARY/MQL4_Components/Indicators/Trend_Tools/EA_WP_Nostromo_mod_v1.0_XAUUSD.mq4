...
extern color            ColorRes=clrTomato;
extern color            ColorPP=clrYellow;
extern color            ColorSup=clrLimeGreen;
...
extern ENUM_LINE_STYLE  StyleFibots1=2;
extern ENUM_LINE_STYLE  StyleFibots2=2;
...
extern color            ColorT=clrLavender;
                  ...
                  bool     future)
{
   ...
   if(PlotZones)
   {
      ...
      if(BuySellZone == 1)
      {
         PlotRectangle(0,"BZ"+name,0,tmestrt,S2,tmend,S3,ColorBuyZone);    
         PlotRectangle(0,"SZ"+name,0,tmestrt,R2,tmend,R3,ColorSellZone);
      }
      if(BuySellZone == 2)
      {
         PlotRectangle(0,"BZ"+name,0,tmestrt,S3,tmend,S4,ColorBuyZone);    
      ...
      if(BuySellZone == 3)
      {
         PlotRectangle(0,"BZ"+name,0,tmestrt,S2,tmend,S4,ColorBuyZone);    
         PlotRectangle(0,"SZ"+name,0,tmestrt,R2,tmend,R4,ColorSellZone);
      }
   }
   ...
   if(PlotPivots){                                 
      ...
      if(PlotPivotLabels){
         PlotText(0,"R6L"+name,0,tmestrt,R6,"R161","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"R5L"+name,0,tmestrt,R5,"R138","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"R4L"+name,0,tmestrt,R4,"R100","Arial",8,ColorT,ANCHOR_LEFT_UPPER);      
         PlotText(0,"R3L"+name,0,tmestrt,R3,"R78","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"R2L"+name,0,tmestrt,R2,"R61","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"R1L"+name,0,tmestrt,R1,"R38","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"PPL"+name,0,tmestrt,PP,"PP","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"S1L"+name,0,tmestrt,S1,"S38","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"S2L"+name,0,tmestrt,S2,"S61","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"S3L"+name,0,tmestrt,S3,"S78","Arial",8,ColorT,ANCHOR_LEFT_UPPER);            
         PlotText(0,"S4L"+name,0,tmestrt,S4,"S100","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"S5L"+name,0,tmestrt,S5,"S138","Arial",8,ColorT,ANCHOR_LEFT_UPPER);
         PlotText(0,"S6L"+name,0,tmestrt,S6,"S161","Arial",8,ColorT,ANCHOR_LEFT_UPPER);}    
      if(PlotPivotPrices){
   ...
   if(PlotFibots){
      ...
      if(PlotFibotLabels){
         PlotText(0,"f236l"+name,0,tmend,f236,"23.6%","Arial",8,ColorT,ANCHOR_RIGHT_UPPER);         
         PlotText(0,"f382l"+name,0,tmend,f382,"38.2%","Arial",8,ColorT,ANCHOR_RIGHT_UPPER);         
         PlotText(0,"f50l"+name,0,tmend,f50,"50%","Arial",8,ColorT,ANCHOR_RIGHT_UPPER);         
         PlotText(0,"f618l"+name,0,tmend,f618,"61.8%","Arial",8,ColorT,ANCHOR_RIGHT_UPPER);         
         PlotText(0,"f786l"+name,0,tmend,f786,"78.6%","Arial",8,ColorT,ANCHOR_RIGHT_UPPER);}
      if(PlotFibotPrices){
