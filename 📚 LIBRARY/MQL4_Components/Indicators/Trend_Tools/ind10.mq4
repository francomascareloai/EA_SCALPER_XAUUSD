...
double G_ibuf_76[];
double G_ibuf_80[];
extern int FasterMovingAverage = 18;
extern int SlowerMovingAverage = 44;
extern int RSIPeriod = 21;
extern int MagicFilterPeriod = 1;
extern int BollingerbandsPeriod = 15;
...
int start() {
   ...
   for (int Li_4 = 0; Li_4 <= Li_0; Li_4++) {
      ...
      if (Gi_132 == TRUE && Gi_136 == TRUE && Gi_144 == TRUE && Gi_140 == TRUE && Gi_148 == TRUE && Gi_172 != 1) {
         G_ibuf_76[Li_4] = Low[Li_4] - (Point * Utstup); 
         ...
         if (Gi_152 == TRUE && Gi_156 == TRUE && Gi_164 == TRUE && Gi_160 == TRUE && Gi_168 == FALSE && Gi_172 != 2) {
            G_ibuf_80[Li_4] = High[Li_4] + (Point * Utstup); 
