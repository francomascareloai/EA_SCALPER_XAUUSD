...
//+-----------------------------------------------------------------*/
string sIndicatorName = "PAMA GannGrid_indv4.3";

//---- window
bool Draw_InMainWindow = true; //set this parameter!
...
#property indicator_width1 1 //price line
...
//-- oscillator (Draw_InMainWindow = false)
//extern bool Show_GridMatrix = true;
//extern bool Show_GannGrid = true;
//-- indicator (Draw_InMainWindow = true)
...
{  
   ...
   for (int i=0; i<nBarsBack+20; i++)
   {
      ...
      MaxPriceLine[i] = EMPTY_VALUE;
      MinPriceLine[i] = EMPTY_VALUE;
   }
//----
   return(0);
}
...
int start()
{
//datetime testTime1=TimeCurrent();
...
//   Print("### ",TimeToStr(testTime2 - testTime1,TIME_MINUTES|TIME_SECONDS));   
   return(0);
}
//+------------------------------------------------------------------+
