      ...
      if(counted_bars>0) counted_bars--;
            ...
            if (TimeFrame != Period())
            {
               ...
               for(int i=limit; i>=0; i--)
               {
                  ...
                  buffer[i]   = iCustom(NULL,TimeFrame,indicatorFileName,PERIOD_CURRENT,pperiod,pprice,MaMethodToUse,psmooth,psmoothMethod,alertsOn,alertsOnCurrent,alertsMessage,alertsSound,alertsNotify,alertsEmail,soundfile,0,y);
                  trend[i]    = iCustom(NULL,TimeFrame,indicatorFileName,PERIOD_CURRENT,pperiod,pprice,MaMethodToUse,psmooth,psmoothMethod,alertsOn,alertsOnCurrent,alertsMessage,alertsSound,alertsNotify,alertsEmail,soundfile,3,y);
