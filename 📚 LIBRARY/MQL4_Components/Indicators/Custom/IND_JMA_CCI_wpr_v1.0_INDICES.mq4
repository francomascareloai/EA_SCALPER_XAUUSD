...
#property indicator_level2 -100.00
...
#property indicator_maximum 350.0
#property indicator_minimum -350.0
//---- input parameters
...
//----
   string short_name="JMA CCI(" + CCIPeriod + " , "+ Len+ ")";
...
//----
   for( shift=BarCount;shift>=0;shift-- )
     {
      series=iCCI(NULL,0,CCIPeriod,PRICE_TYPICAL,shift);
      if (fF0 < 61)
        {
         fF0= fF0 + 1;
         buffer[fF0]=series;
