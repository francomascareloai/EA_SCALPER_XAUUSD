...
int init() {
   ...
   IndicatorShortName("FSP Ultra Conservative Entry");
...
int start() {
   ...
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) {
      G_ibuf_92[Li_104] = iMAOnArray(G_ibuf_84, 0, 20, 5, MODE_SMA, Li_104);
      G_ibuf_96[Li_104] = iBandsOnArray(G_ibuf_84, 0, 20, 2, 5, 1, Li_104);
      G_ibuf_100[Li_104] = iBandsOnArray(G_ibuf_84, 0, 20, 2, 5, 2, Li_104);
   }
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) {
   ...
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) {
      ...
      if (G_ibuf_88[Li_104] > 0.0 && G_ibuf_84[Li_104] > 0.0 && G_ibuf_84[Li_104] > G_ibuf_96[Li_104] && G_ibuf_84[Li_104] > G_ibuf_92[Li_104]) {
         G_ibuf_76[Li_104] = 1;
         G_ibuf_80[Li_104] = 0.0;
      }
      if (G_ibuf_88[Li_104] < 0.0 && G_ibuf_84[Li_104] < 0.0 && G_ibuf_84[Li_104] < G_ibuf_100[Li_104] && G_ibuf_84[Li_104] < G_ibuf_92[Li_104]) {
         G_ibuf_80[Li_104] = 1;
