...
string key = "Flexy The Dragon v2.1";
...
extern double gs_multiplicator = 1.0;              // Grid Multiplier (only for martingale)
sinput string gap21; // .
...
sinput string gap32; // .
extern double reduce_tp          = 0.0;            // Reduce Profit
sinput string reduce_tp2;                          // (reduces take profit per grid order, min. 1pip)
extern int grid_partially_close  = 0;              // Partial Closing
