...
double Var1 = (High[8] + High[7] + High[6] + High[5] +High[4] + High[3]+High[2]+High[1]) / 8;
double Var2 = (Low[8]+Low[7]+Low[6]+Low[5]+Low[4]+Low[3]+Low[2]+Low[1])/8;
double Var3 = ( Var1  +  Var2 ) * 0.5;
