//+------------------------------------------------------------------+
//|                                          EA 2050 Pro.mq4 |
//|                       Copyright 2020, P. K. Thakur EXPERTS PRO . |
//|                                                                  |                              \
//+------------------------------------------------------------------+
#property copyright "Copyright 2020, P.K.Thakur EXPERTS PRO"
#property link      ""

#property description   ""
#property description   "P.K.Thakur EXPERTS PRO"
#property description   "Recommended 2000USD/cents for safe"
#property description   "TF m15 pair EURUSD low DD 1%-10%, GBPUSD DD 10%-20%"
#property description   "Limited Time VERSION 0.2"
//datetime expiryDate = D'2020.12.22 00:00'; //change as per your requirement
//+------------------------------------------------------------------+
//| Expert tick function for  Date                                          |
//+------------------------------------------------------------------+
//void OnTick()
//{
//if (TimeCurrent() > expiryDate) Alert(" ** HEY MY BROTHER YOUR EA EXPIRED ** ");
//if (TimeCurrent() > expiryDate) return;}
//+------------------------------------------------------------------+
//| Expert initialization function                                   |
//+------------------------------------------------------------------+

extern string DEVELOPED_by = "P.K. Thakur";
...
extern string StrategyPRO_1 = "Set Current Trade & Orders";
...
double Gd_352;
bool Gi_360;
string Gs_364 = "EA 2020 original";
int Gi_372 = 0;
int Gi_376;
int Gi_380 = 0;
double Gd_384;
...
double Gd_428;
double Gd_436;
extern string MartiPROset = "Setting for MartiPRO";
...
extern string EXPERTSPro = "Setting for ExpertsPRO";
...
double Gd_920;
bool Gi_928;
string Gs_932 = "EA 2050 EXPERTS PRO";
int Gi_940 = 0;
int Gi_944;
int Gi_948 = 0;
double Gd_952;
...
int init() {
   ...
   G_text_1464 = "     ";
   ObjectSetText("Lable", G_text_1464, 14, "Fixedsys", Blue);
   if (Gi_1480) {
      if (KEY != "") {
         Gi_1492 = 0;
...
/*   if (!IsDemo())
   ...
   ObjectSetText("1", "EA 2020 PRO", 50, "Comic Sans MS", Blue);
