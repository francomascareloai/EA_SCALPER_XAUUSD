...
if (L_d_34 != 0) {
    ...
    Print("Division by zero detected. L_d_34 is zero.");
    L_d_29 = 0; // Or handle appropriately
}
   }
   if (L_i_18 > 0) {
...
if (L_d_35 != 0) {
    ...
    Print("Division by zero detected. L_d_35 is zero.");
    L_d_33 = 0; // Or handle appropriately
}
   }
   if (L_b_0) {
      L_i_20 = OrdersTotal() - 1;
