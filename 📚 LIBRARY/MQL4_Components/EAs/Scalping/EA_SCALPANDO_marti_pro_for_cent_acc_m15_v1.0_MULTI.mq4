//+------------------------------------------------------------------+
//|                                          SCALPANDO MArti PRO.mq4 |
//|                               Copyright 2020, JMAR EXPERTS PRO . |
//|                                                                  |                              \
//+------------------------------------------------------------------+
#property copyright "Copyright 2019, JMAR EXPERTS PRO"
#property link      "t.me/robotprofitsPRO"

#property description   "MARTI PRO SCALPER COMBINED HEDGE "
#property description   "JMAR EXPERTS PRO"
#property description   "Recomendado deposito FBS 10000$cents or 100$ XM Micro ULTRALOW acc/1 Pair= EURJPY or GBPJPY"
#property description   "TIMEFRAME m5/m15/H1"
#property description   "FULL VERSION"
//+------------------------------------------------------------------+
//| Expert initialization function                                   |
//+------------------------------------------------------------------+

extern string DEVELOPED_by = "t.me/robotprofits +639485758802";
...
extern string INDICATORserver = "35.176.119.134";
...
double Gd_352;
bool Gi_360;
string Gs_364 = "SCALPANDO original";
int Gi_372 = 0;
int Gi_376;
int Gi_380 = 0;
double Gd_384;
...
double Gd_920;
bool Gi_928;
string Gs_932 = "JMAR EXPERTS PRO";
int Gi_940 = 0;
int Gi_944;
int Gi_948 = 0;
double Gd_952;
...
int init() {
   ...
   G_text_1472 = "EL tarantados Marti PRO ,, .";
   ...
   G_text_1464 = "     https:t.me/robotprofits Developed By JMAR EGONIA";
...
/*   if (!IsDemo())
   ...
   ObjectSetText("1", "Scalpando Marti PRO", 50, "Comic Sans MS", Blue);
