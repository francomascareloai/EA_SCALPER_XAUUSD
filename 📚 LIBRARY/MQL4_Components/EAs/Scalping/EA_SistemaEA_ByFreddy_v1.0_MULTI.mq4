...
extern string s00 = "** Configuración de la estrategia **";
extern bool Largos? = TRUE;
extern bool Cortos? = TRUE;
extern bool Repetir? = TRUE;
extern int TamanoRejilla = 10;
extern string s01 = "** Gestión de stops **";
int gi_108 = 0;
...
extern bool OperarSiempre? = TRUE;
extern string sh70 = "*** Configurar Horario de Operación 1 (de 00:00 a 23:59) ***";
extern bool OperarHorario1? = TRUE;
extern string Horario1_Desde = "07:30";
extern string Horario1_Hasta = "14:00";
extern string sh80 = "*** Configurar Horario de Operación 2 (de 00:00 a 23:59) ***";
extern bool OperarHorario2? = FALSE;
extern string Horario2_Desde = "14:00";
extern string Horario2_Hasta = "22:00";
extern string sh90 = "*** Configurar Horario de Operación 3 (de 00:00 a 23:59) ***";
...
int abrirPosicion(int a_cmd_0, double a_price_4 = 0.0, double ad_12 = 0.0, double ad_20 = 0.0, double a_lots_28 = 0.0, string a_comment_36 = "", int a_datetime_44 = 0) {
   ...
   Alert("Se intentó operar durante " + SegundosParaReintentarOperar + " segundos. Error #" + l_error_64);
   return (-1);
}
