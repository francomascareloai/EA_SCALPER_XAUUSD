...
input string   _="MM";
input int      Risk=111;
input bool     Calculate Lotsize automatic =true;
input double   Manual Lotzize (if automatic=false) =0.01;
input bool     PropFirm =false;
input bool     Activate Trailing  =false;
input double   TrailingStart =52.0;
input double   TrailingStop =17.0;
input string   _;
input string   _="MC";
input int      MagicNumber=5005;
input string   Comment for EA Order ="AI GEN XII";
input string   _;
input string   _="GPT";
input string   GPTModel="GPT-4o";
input string   Strategy Aggressivity ="Low Aggressivity";
input string   Chat GPT Function= "Advisor only";
