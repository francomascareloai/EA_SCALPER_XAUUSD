...
input string ExpertName=" AutoTraderz ID v 2.00 ";
input string TELWGRAMName=" https://t.me/AutoTraderz ";
...
if (ObjectCreate(0, str_0, OBJ_RECTANGLE_LABEL, 0, 0, 0))
      ...
      str_3 = "-----------------------------------------------------------------------------------------------------------------------------";
            ...
            ObjectSetInteger(0, str_22, 9, 0);
             str_13 = "Account Number                     :"+AccountNumber();
            str_33 = "ERROR_TEXT4";
            ...
            str_14 = "Account Leverage                    :"+AccountInfoInteger(ACCOUNT_LEVERAGE);
            str_44 = "ERROR_TEXT3";
            ...
            str_15 = "Account Balance                      :"+AccountBalance();
            str_55 = "ERROR_TET24";
            ...
            str_16 = "Account Equity                        :"+AccountInfoDouble(ACCOUNT_EQUITY);
            str_66 = "ERROR_TEXT";
            ...
            str_28 = "Server Time                             :"+TimeCurrent();
            str_38 = "ERROR_TEkfk";
            ...
            ObjectSetInteger(0, str_80, 9, 0);
             str_35 = "Total Profit/Loss : "+AccountProfit();
            str_36 = "ERROR_T285";
