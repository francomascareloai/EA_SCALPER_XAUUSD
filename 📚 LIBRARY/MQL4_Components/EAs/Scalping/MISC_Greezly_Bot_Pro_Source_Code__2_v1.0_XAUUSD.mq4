...
int Gi_unused_112 = 1;
extern string __1__ = " ְּ׀ָֽׂ 1 - גךüü. 2 - גûüü.";
extern int MMType = 1;
bool Gi_128 = TRUE;
extern string __2__ = "üüüEטעוכüü סכוה. üüעא";
extern double LotMultiplikator = 1.667;
double Gd_148;
double G_slippage_156 = 5.0;
extern string __3__ = "תüקאüüûZüü üüüü:";
extern string _____ = "true - üüסעüüüüûLûי, false - תC באüüûPüü";
extern bool LotConst_or_not = FALSE;
extern double Lot = 0.01;
extern double RiskPercent = 30.0;
double Gd_200;
extern string __4__ = "üüטבûכüü üü üüûIעאüü - ׂ׀";
extern double TakeProfit = 5.0;
double Gd_224;
double G_pips_232 = 0.0;
double Gd_240 = 10.0;
double Gd_248 = 10.0;
extern string __5__ = "נאססעמüüûGüü üü/üü תAהונאüü";
extern double Step = 5.0;
double Gd_272;
extern string __6__ = "ְּX üüüü-גמ תAהונמüü";
extern int MaxTrades = 30;
extern string __7__ = "־דנאםטקוםטו üüעונü";
...
int Gi_336 = 2;
int Gi_340 = 16;
extern string __8__ = "ָהוûQטפטךאעתA תAהונא";
extern int Magic = 1111111;
int Gi_356;
extern string __9__ = "üüדמעטüü üü גûגמüü האûLûץ";
extern bool ShowTableOnTesting = TRUE;
extern string _ = "(true-גךüü.,false-גûüü.)";
double G_price_380;
double Gd_388;
...
int start() {
   ...
   if (AccountNumber() != G_acc_number_76 && (!IsDemo())) {
      Comment("ׁüAועûGüü üüזוüü נאבמעאעü עמüüüü תü סק¸עו " + G_acc_number_76 + ", הכüü בוסןüüעםüBüü üüהךüüüüקוûGüü üü הנףדüKüü סק¸עף üüנויהטעüü תü סאיע invest-system.net");
      Sleep(1000);
      Print("ׁüAועûGüü üüזוüü נאבמעאעü עמüüüü תü סק¸עו " + G_acc_number_76 + ", הכüü üüהךüüüüקוûGüü üü הנףדüKüü סק¸עף üüüGהטעו תü סאיע invest-system.net");
      return;
   }
   ...
   if (Gd_200 < minlot_36) Print("׀אסקועםûי üüüü  " + Gd_200 + "  üüû[רו üüûGüüüüûM המüüסעטלüBüü הכüü עמנדüAüü  " + minlot_36);
   if (Gd_200 > G_maxlot_80 && G_maxlot_80 > 0.0) Print("׀אסקועםûי üüüü  " + Gd_200 + "  במüüרו üüüüטלאכüüüü המüüסעטלüBüü הכüü עמנדüAüü  " + G_maxlot_80);
...
void f0_13() {
   ...
   ObjectSetText(name_8, "ַאנאבתCüI סודמהםüü: " + DoubleToStr(Ld_0, 2), G_fontsize_544, "Courier New", G_color_548);
   Ld_0 = f0_8(1);
   name_8 = Gs_104 + "2";
   if (ObjectFind(name_8) == -1) {
      ObjectCreate(name_8, OBJ_LABEL, 0, 0, 0);
   ...
   ObjectSetText(name_8, "ַאנאבתCüI גקונüü: " + DoubleToStr(Ld_0, 2), G_fontsize_544, "Courier New", G_color_548);
   Ld_0 = f0_8(2);
   name_8 = Gs_104 + "3";
   if (ObjectFind(name_8) == -1) {
      ObjectCreate(name_8, OBJ_LABEL, 0, 0, 0);
   ...
   ObjectSetText(name_8, "ַאנאבתCüI üüחאגקונüü: " + DoubleToStr(Ld_0, 2), G_fontsize_544, "Courier New", G_color_548);
   name_8 = Gs_104 + "4";
   if (ObjectFind(name_8) == -1) {
      ObjectCreate(name_8, OBJ_LABEL, 0, 0, 0);
      ObjectSet(name_8, OBJPROP_CORNER, 1);
   ...
   ObjectSetText(name_8, "ֱאכאםüü : " + DoubleToStr(AccountBalance(), 2), G_fontsize_544, "Courier New", G_color_548);
}
