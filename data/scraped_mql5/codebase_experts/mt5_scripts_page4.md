...
Source: https://www.mql5.com/en/code/mt5/scripts/page4
...
[TickCompressor](/en/code/30791 "TickCompressor")

Convert MqlTick-s into minified structures to free RAM or store tick arrays in a compact files.

[KOB Requisites Script](/en/code/30776 "KOB Requisites Script")
...
[Kamikaze Trading](/en/code/30728 "Kamikaze Trading")

This script opens order with maximal amount of volume available.

[Check Margin](/en/code/30725 "Check Margin")

required margin and maximum volume calculator.

[Identify potential Trends/Range (Pivot Points)](/en/code/30212 "Identify potential Trends/Range (Pivot Points)")
...
[Open Random Charts](/en/code/30185 "Open Random Charts")

This script opens randomly selected charts and applies user-defined template.

[ComeBacker Trading](/en/code/30025 "ComeBacker Trading")

short-term forex strategy for beginners.

[Modify SL and/or TP](/en/code/29984 "Modify SL and/or TP")
...
[Profit and Losses represented in Pips](/en/code/29922 "Profit and Losses represented in Pips")

Simple script to see your current Profit Losses in Pips.

[Forex market sessions identification](/en/code/29842 "Forex market sessions identification")
...
[Quick Market-watch Launcher v1.1](/en/code/29460 "Quick Market-watch Launcher v1.1")
...
[Alphabet structure](/en/code/29449 "Alphabet structure")

Sets of latin, russian characters, digits, punctuation, etc.

[Fast Pending Orders](/en/code/29385 "Fast Pending Orders")
...
[Cross](/en/code/27597 "Cross")

Simple code for Candle Cross above or below Conditions..

[Scalp All](/en/code/27162 "Scalp All")

Opens random positions on marketwatch symbols.

[LotLoss](/en/code/27132 "LotLoss")

Simple risk management tool.

[Coin Toss Trading](/en/code/27119 "Coin Toss Trading")

This script opens a buy or sell order randomly having equally spaced take-profit and stop-loss levels.

[Quick Script to browse Signals, searching for your own parameters.](/en/code/27082 "Quick Script to browse Signals, searching for your own parameters.")

Simplified Script to find signals based on user parameters

[Open/Close Charts](/en/code/27019 "Open/Close Charts")
...
[Instance ID script for MT4/MT5](/en/code/26945 "Instance ID script for MT4/MT5")

This script allows a user to find out instance\_id of the running MetaTrader instance/installation.

[Programming Patters - Builder (classic)](/en/code/26799 "Programming Patters - Builder (classic)")

Separate the construction of a complex object from its representation so that the same construction process can create different representations.

[Programming Patterns - Factory Method](/en/code/26790 "Programming Patterns - Factory Method")

Define an interface for creating an object, but let subclasses decide which class to instantiate. Lets a class defer instantiation to subclasses.

[Programming Patterns - Abstract Factory](/en/code/26780 "Programming Patterns - Abstract Factory")

Provides an interface for creating families of related or dependent objects without specifying their concrete class.

[Programming Patterns - Observer](/en/code/26732 "Programming Patterns - Observer")
...
[Programming Patterns - Decorator](/en/code/26693 "Programming Patterns - Decorator")
...
[ArrowDrawingIndiEu](/en/code/25733 "ArrowDrawingIndiEu")

This indi will draw OBJ\_ARROW\_BUY/OBJ\_ARROW\_SELL when find signals on Arrow Indi Buffers.

[Export Summary Grouped by Trading Days](/en/code/25700 "Export Summary Grouped by Trading Days")

The script exports summary of closed trades grouped by each trading day to .csv file

[Export Summary Grouped by Symbols](/en/code/25667 "Export Summary Grouped by Symbols")

The script exports summary of closed trades grouped by each currency pair to .csv file

[Close-All](/en/code/25650 "Close-All")

A script to close all market positions and/or pending orders.

[Change SL/TP on chart drop off](/en/code/25433 "Change SL/TP on chart drop off")
...
[Export trade history to CSV](/en/code/24626 "Export trade history to CSV")
...
[Export Deals History V1](/en/code/24608 "Export Deals History V1")
