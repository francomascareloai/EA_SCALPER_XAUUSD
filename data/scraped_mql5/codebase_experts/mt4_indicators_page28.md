...
Source: https://www.mql5.com/en/code/mt4/indicators/page28
...
# MQL4 Source Codes of Technical Indicators for MetaTrader 4 - 28
...
[1](/en/code/mt4/indicators)[...](/en/code/mt4/indicators/page11)[21](/en/code/mt4/indicators/page21)[22](/en/code/mt4/indicators/page22)[23](/en/code/mt4/indicators/page23)[24](/en/code/mt4/indicators/page24)[25](/en/code/mt4/indicators/page25)[26](/en/code/mt4/indicators/page26)[27](/en/code/mt4/indicators/page27)[28](/en/code/mt4/indicators/page28)[29](/en/code/mt4/indicators/page29)[30](/en/code/mt4/indicators/page30)[31](/en/code/mt4/indicators/page31)[32](/en/code/mt4/indicators/page32)[33](/en/code/mt4/indicators/page33)[34](/en/code/mt4/indicators/page34)[35](/en/code/mt4/indicators/page35)[...](/en/code/mt4/indicators/page49)[63](/en/code/mt4/indicators/page63)

latest |

[best](/en/code/mt4/indicators/best)

[EURX Euro Currency Index](/en/code/11059 "EURX Euro Currency Index")

EURX=34.38805726 x [(EURUSD x 0.3155) + (EURGBP x 0.3056) + (EURJPY x 0.1891) + (EURCHF x 0.1113) + (EURSEK x 0.0785)]

[USD Strength Indicator CUSIV01](/en/code/11054 "USD Strength Indicator CUSIV01")
...
[TRYBASK Turkish Lira index (Sepet Kur)](/en/code/11053 "TRYBASK Turkish Lira index (Sepet Kur)")

TRYBASK= 1 x [(USDTRY x 0.50) + (EURTRY x 0.50)]

[Candle Closing Time Remaining (CCTR) Version 3](/en/code/11051 "Candle Closing Time Remaining (CCTR) Version 3")

Candle Closing Time Remaining (CCTR) is an indicator which displays the remaining time for an open candle to be closed.

[a\_day](/en/code/11049 "a_day")
...
[a\_info](/en/code/11041 "a_info")

The indicator shows the current market conditions.

[a\_candle](/en/code/11034 "a_candle")

The indicator shows the remaining candle time.

[Auto uploader](/en/code/11038 "Auto uploader")
...
[Open Position v3a - Updated for MT4 Build 600](/en/code/11013 "Open Position v3a - Updated for MT4 Build 600")

Displays open position: Symbol + Lots + Points + Profit (Updated for MT4 Build 600)

[TimeZones Six v2](/en/code/11012 "TimeZones Six v2")

Display up to six Times Zones. Hide Time Zones not required.

[Open position with STOCH and RSI](/en/code/11010 "Open position with STOCH and RSI")

This indicator shows when to buy and sell in the right time..so you don't miss the train.

[Spread Tracker](/en/code/10983 "Spread Tracker")

Tracking Variable Spreads with an Offline Chart

[Advanced MTF RSI](/en/code/10972 "Advanced MTF RSI")
...
[Real Cloud](/en/code/10826 "Real Cloud")

Cloud indicator based on 2 Moving Averages.

[b Clock Plus](/en/code/10969 "b Clock Plus")

This is an updated version of b Clock.

[MoneyManagement visualizer](/en/code/10948 "MoneyManagement visualizer")
...
[Brooky Psar Levels](/en/code/10971 "Brooky Psar Levels")

Support and Resistance levels using the psar logic.

[Key Level Indicator](/en/code/10973 "Key Level Indicator")
...
[Tick Chart and Record](/en/code/10890 "Tick Chart and Record")

Record, storage and displays of data, fully tick chart in MetaTrader.

[PZ Pivot Points](/en/code/10990 "PZ Pivot Points")

Yet another pivot points indicator, light and customisable.

[Positive Volume Index](/en/code/10989 "Positive Volume Index")

This indicator, recognizing trends in an early stage, can be used to get ready for a break-out scenario.

[Market crash alert when you sleep](/en/code/11000 "Market crash alert when you sleep")

Indicator that shows you market push and future 80% of next big trend.

[Rogue tick detector](/en/code/11004 "Rogue tick detector")
...
[Simple Support and Registance Lines](/en/code/11006 "Simple Support and Registance Lines")

This indicator shows simple Support and Registance lines.

[Stretch Breakout Channel](/en/code/10955 "Stretch Breakout Channel")
...
[CheckPower of Bulls/Bears](/en/code/10958 "CheckPower of Bulls/Bears")

Based on ibull/ibear, but compare power to define good entry bars.

[Kijun Sen and Envelope](/en/code/10952 "Kijun Sen and Envelope")

Kijun Sen and Envelope.

[ZFXiSwap2](/en/code/10954 "ZFXiSwap2")

Any symbol Bid, LastDayDiff(% or pip), Spread, Swap, Hi-Lo Today, Hi-Lo Week, Hi-Lo Mounth view to separate window.

[Trendsignal indicator version 2](/en/code/10928 "Trendsignal indicator version 2")

Trendsignal indicator with potential area drawn on chart.

[Channels](/en/code/10882 "Channels")

The indicator finds and draws linear channels using all timeframes from M1 minute to MN.

[Limited Donchian Chanel Indicator](/en/code/10916 "Limited Donchian Chanel Indicator")

Limited distance between the upper and lower donchian line.

[GreedyPigAnalyzerIndicator](/en/code/10896 "GreedyPigAnalyzerIndicator")
