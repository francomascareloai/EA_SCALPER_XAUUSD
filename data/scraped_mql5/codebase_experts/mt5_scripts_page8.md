...
Source: https://www.mql5.com/en/code/mt5/scripts/page8
...
# MQL5 Source Codes of Scripts for MetaTrader 5 - 8
...
[SetBuyStopOrder](/en/code/975 "SetBuyStopOrder")
...
[SetSellStopOrder](/en/code/974 "SetSellStopOrder")
...
[SetSellLimitOrder](/en/code/973 "SetSellLimitOrder")
...
[StopOutPrice](/en/code/795 "StopOutPrice")
...
[sSyncScroll](/en/code/677 "sSyncScroll")

Script for the charts simultaneous scrolling.

[ToClearChart](/en/code/664 "ToClearChart")
...
[Save history to HST](/en/code/780 "Save history to HST")
...
[Exposure](/en/code/354 "Exposure")

This script reads all opened position and calculates their exposure for each currency.

[sTimeToVariables](/en/code/353 "sTimeToVariables")

The script converts the time, represented as datetime variable into the year, month, day, hour, minutes and seconds.

[Demo\_BitmapOffset (OBJPROP\_XOFFSET and OBJPROP\_YOFFSET)](/en/code/325 "Demo_BitmapOffset (OBJPROP_XOFFSET and OBJPROP_YOFFSET)")
...
[ChartNavigate Demo](/en/code/296 "ChartNavigate Demo")

Simple script with demonstration of use of the ChartNavigate() function.

[Demo\_Create\_OBJ\_BITMAP\_Script](/en/code/290 "Demo_Create_OBJ_BITMAP_Script")

The example of chart background image, created using the object of OBJ\_BITMAP type.

[Export Indicator's Values](/en/code/273 "Export Indicator's Values")

This script exports indicator's values to CSV file.

[sChartsSynchroScroll\_v2](/en/code/266 "sChartsSynchroScroll_v2")

New version of the sChartsSynchroScroll script.

[SelfGenerator](/en/code/260 "SelfGenerator")
...
[History of trade](/en/code/243 "History of trade")
...
[s-LastPinkEventDate](/en/code/205 "s-LastPinkEventDate")

Since Terminal build 344 added display of economic calendar news using special graphical objects (OBJ\_EVENT). A script that outputs as a demonstration of the Economic Calendar with current economic data, the date of the last major (Pink) event.

[ytg\_Percent\_Lot](/en/code/188 "ytg_Percent_Lot")

The script calculates the number of lots to trade using the specified percentage of risk funds.

[Export historical data](/en/code/124 "Export historical data")

The script purpose is to export historical rates data to format, convenient for analysis in external programs.

[Clipboard](/en/code/104 "Clipboard")
