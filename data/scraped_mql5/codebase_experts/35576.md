...
v1.02b: Hotfix for static int chartBars, where it would be forever the first call value of Bars(Symbol(), PERIOD\_CURRENT) and would not update thereafter (guarantees that invalid candles are not visible)
