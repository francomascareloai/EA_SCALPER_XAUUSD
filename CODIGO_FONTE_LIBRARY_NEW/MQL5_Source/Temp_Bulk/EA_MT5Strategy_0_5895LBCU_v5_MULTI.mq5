...
//|    Generated at 12/10/2024 02:05
//| 
//|    Backtested on XAUUSDGOLD / M15, 2019.10.01 - 2024.10.16 
//+------------------------------------------------------------------+
...
input string CustomComment = "MT5Strategy_0_5895LBCU";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 54216;        //MagicNumber
...
input int CCIChangesPeriod1 = 14;        //CCIChangesPeriod1
input int ExitAfterBars1 = 450;        //ExitAfterBars1
input double StopLoss1 = 1451;        //StopLoss1
input double TrailingStopCoef1 = 3.5;        //TrailingStopCoef1
...
#define LOWESTINRANGE_1 0     //iCustom(NULL,0, "SqLowestInRange", "22:00", "14:00")
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 0.8, PRICE_CLOSE)
#define HIGHESTINRANGE_1 2     //iCustom(NULL,0, "SqHighestInRange", "22:00", "14:00")
#define CCI_1 3     //iCustom(NULL,0, "SqCCI", CCIChangesPeriod1, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 47)
...
string sqStrategyName = "Strategy 0.5895";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 0), 6) >= NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 0), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 0), 6) <= NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 0), 6));

     LongExitSignal = changesUp(CCI_1, 0);

     ShortExitSignal = changesDown(CCI_1, 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqWeekly(NULL,0, "High", 0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 104);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqWeekly(NULL,0, "Low", 0), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "22:00", "14:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 0.8, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "22:00", "14:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[CCI_1] = iCustom(NULL,0, "SqCCI", CCIChangesPeriod1, PRICE_CLOSE);
