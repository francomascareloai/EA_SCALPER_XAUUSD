...
int init() {
   ...
   IndicatorShortName("FSP Fast Entry");
...
int start() {
   ...
   for (int Li_104 = 0; Li_104 < Li_100; Li_104++) {
      high_44 = High[iHighest(NULL, 0, MODE_HIGH, Gi_76, Li_104)];
      low_36 = Low[iLowest(NULL, 0, MODE_LOW, Gi_76, Li_104)];
      ...
      G_ibuf_100[Li_104] = MathLog((Ld_12 + 1.0) / (1 - Ld_12)) / 2.0 + Ld_28 / 2.0;
      Ld_20 = Ld_12;
      Ld_28 = G_ibuf_100[Li_104];
   }
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) G_ibuf_108[Li_104] = iMAOnArray(G_ibuf_100, 0, G_period_84, Gi_88, MODE_SMA, Li_104);
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) {
      high_92 = High[iHighest(NULL, 0, MODE_HIGH, Gi_80, Li_104)];
      low_84 = Low[iLowest(NULL, 0, MODE_LOW, Gi_80, Li_104)];
      ...
      G_ibuf_104[Li_104] = MathLog((Ld_60 + 1.0) / (1 - Ld_60)) / 2.0 + Ld_76 / 2.0;
      Ld_68 = Ld_60;
      Ld_76 = G_ibuf_104[Li_104];
   }
   for (Li_104 = 0; Li_104 < Li_100; Li_104++) {
      G_ibuf_92[Li_104] = EMPTY_VALUE;
      G_ibuf_96[Li_104] = EMPTY_VALUE;
      if (G_ibuf_104[Li_104] > 0.0 && G_ibuf_100[Li_104] > G_ibuf_108[Li_104]) {
         G_ibuf_92[Li_104] = 1;
