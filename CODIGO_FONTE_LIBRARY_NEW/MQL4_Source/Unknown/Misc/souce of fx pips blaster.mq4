...
int init() {
   ...
   gda_1016[13] = D'28.03.2012 09:00';
   gda_1012[13] = D'31.10.2012 10:00';
   gda_1016[12] = D'29.03.2011 09:00';
   gda_1012[12] = D'25.10.2011 10:00';
   gda_1016[11] = D'30.03.2010 09:00';
   gda_1012[11] = D'26.10.2010 10:00';
   gda_1016[10] = D'29.03.2009 09:00';
   gda_1012[10] = D'25.10.2009 10:00';
   gda_1016[9] = D'30.03.2008 09:00';
   gda_1012[9] = D'26.10.2008 10:00';
   gda_1016[8] = D'25.03.2007 09:00';
   gda_1012[8] = D'28.10.2007 10:00';
   gda_1016[7] = D'26.03.2006 09:00';
   gda_1012[7] = D'29.10.2006 10:00';
   gda_1016[6] = D'27.03.2005 09:00';
   gda_1012[6] = D'30.10.2005 10:00';
   gda_1016[5] = D'28.03.2004 09:00';
   gda_1012[5] = D'31.10.2004 10:00';
   gda_1016[4] = D'30.03.2003 09:00';
   gda_1012[4] = D'26.10.2003 10:00';
   gda_1016[3] = D'31.03.2002 09:00';
   gda_1012[3] = D'27.10.2002 10:00';
   gda_1016[2] = D'25.03.2001 09:00';
   gda_1012[2] = D'28.10.2001 10:00';
   gda_1016[1] = D'26.03.2000 09:00';
   gda_1012[1] = D'29.10.2000 10:00';
...
int start() {
   ...
   bool li_192;
   bool li_196;
   string ls_0 = "2050.08.08";
   int str2time_8 = StrToTime(ls_0);
   /*if (TimeCurrent() >= str2time_8) {
      Alert("silahkan hubungi saya 085740108228 untuk memperpanjang");
      return (0);
   }*/
   if (closeall) {
      f0_7();
   ...
   if (generalfilter2) {
      ...
      if (startminutes2 < 10) ti_0 = "0" + startminutes2;
      if (startminutes2 > 9) ti_828 = startminutes2;
      g_str2time_852 = StrToTime(ls_20 + " " + gs_820 + ":" + ti_0);
