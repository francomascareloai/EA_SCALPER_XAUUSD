...
int start()
{
  ...
  {
     int result=0;
     if((iRSI(NULL,0,5,PRICE_CLOSE,2)<20)&&(iRSI(NULL,0,5,PRICE_CLOSE,1)>20)) // Here is your open buy rule
     {
     ...
     if((iRSI(NULL,0,5,PRICE_CLOSE,2)>80)&&(iRSI(NULL,0,5,PRICE_CLOSE,1)<80)) // Here is your open Sell rule
     {
  ...
  for(int cnt=0;cnt<OrdersTotal();cnt++)
     {
      ...
      if(OrderType()<=OP_SELL &&   
         ...
         )  
        {
         if(OrderType()==OP_BUY)  
           {
              if((iRSI(NULL,0,5,PRICE_CLOSE,2)>50)||(iRSI(NULL,0,5,PRICE_CLOSE,1)<20)) //here is your close buy rule
              {
           ...
           {
                if((iRSI(NULL,0,5,PRICE_CLOSE,2)<50)||(iRSI(NULL,0,5,PRICE_CLOSE,1)>80)) // here is your close sell rule
                {
                   OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);
                }
            if(TrailingStop>0)  
