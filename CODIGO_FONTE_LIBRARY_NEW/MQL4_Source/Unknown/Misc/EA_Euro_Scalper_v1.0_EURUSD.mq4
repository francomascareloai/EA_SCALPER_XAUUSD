...
//+------------------------------------------------------------------+
#property copyright "Copyright 2020, Septifx Software Corp.";
#property link "https://www.formulascalper.com";
#property version "1.00";
#property strict

extern string Minimal_Deposit = "$200 Cent NDD";
extern string Time_Frame = "Pasang di Time Frame M1";
