...
extern bool   ExtPushNotification            = true;
extern bool   ExtPushNotificationZigZag      = true;
extern string AlertText         = "New pattern available";
        ...
        if (vPatOnOff && !vPatNew)
          {
           ...
           if(ExtPushNotification) SendNotification(Symbol()+" , "+Period()+" , "+vBullBear+", "+vNamePattern);
           if(ExtPlayAlert) 
           {
         ...
         if (timeFr2new!=afr[1] || (timeFr3new!=afr[2] && timeFr2new==afr[1]) || timeFr2new<afr[2])
           {
            ...
            if (ExtAlert)
              {
               Alert (Symbol(),"  ",Period(),"a new ray ZigZag");
               PlaySound("alert.wav");
              }
            afrm=true;
           }
