...
extern int MagicNumber = 007; // Magic Number
extern int Slippage = 1;
extern string title1 = "TIME SETTINGS"; // Time Setting
extern int StartHour = 16; // START TRADING HOUR
extern int EndHour = 22; // END TRADING HOUR
extern int Secs = 1; // ORDER MODIFICATIONS (Should be same as TF)
...
extern int MaxSpread = 16000; // Max Spread Limit
