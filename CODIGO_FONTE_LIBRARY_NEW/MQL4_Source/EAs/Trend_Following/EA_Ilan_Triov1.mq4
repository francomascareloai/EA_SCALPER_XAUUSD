...
//       Отключен информационный индикатор (для ускорения тестирования и оптимизации)
//       Добавлена переменная PeriodRSI, позволяющая выбирать таймфрейм 
//       для RSI:1=M1, 2=M5, 3=M15, 4=M30, 5=H1, 6=H4, 7=D1, 8=W1, 9=MN1 
...
extern double TakeProfit = 20.0;    // тейк профит
bool UseEquityStop = FALSE;         // использовать риск в процентах
double TotalEquityRisk = 20.0;      // риск в процентах от депозита
bool UseTrailingStop = true;       // использовать трейлинг стоп
double TrailStart = 50.0;           // трейлингстарт
double TrailStop = 50.0;             //трейлингстоп
...
//========================================================================//
   ...
   if (totals_15==0 || orders_15 < 1) {
      ...
      if (!gi_324_15 && !gi_320_15) {
         ...
         if (l_iclose_8 > l_iclose_16) {if (NewCycle) {//!!!
