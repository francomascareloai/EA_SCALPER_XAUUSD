...
//|                                           https://t.me/Astrologe |
//+------------------------------------------------------------------+
#property copyright "Life In Dreams World"
#property link      "https://t.me/LifeInDreamsWorld"
#property version   "1.5"
#property strict
#property description " GOLD HITS"


string EA;
string  EA1                             =  "GOLD HITS";   //  Comment To Dispaly In Order
extern int     magic                    =  1;                //  Magic Number
extern double  lot_initial              =  0.01;                   //  Lot Started
extern double  multiplier               =  2.0;                    //  Multiplier  
extern int     takeprofit               =  50;                     //  TakeProfit (Pips)
extern int     distance_pips            =  20;                     //  Distance Open Position (Pips)
extern int     maxlayer                 =  100;                    //  Max Position(layer) Per Side
bool    display_info             =  false;                   //  Show Info On Chart
