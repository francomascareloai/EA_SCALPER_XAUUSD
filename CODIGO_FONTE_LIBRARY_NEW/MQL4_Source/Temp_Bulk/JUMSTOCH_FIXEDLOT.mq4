...
int G_magic_420;
int G_magic_424;
string Gs_428 = "+Jum+StoCh-1+FL";
string Gs_436 = "+Jum+StoCh-2+FL";
string Gs_444 = "+Jum+StoCh-3+FL";
string Gs_452 = "+Jum+StoCh-4+FL";
string Gs_dummy_460;
string Gs_dummy_468;
string Gs_dummy_476;
string Gs_dummy_484;
...
int start() {
   ...
   if (!Close_Panic) {
      if ((!Close_Buy_Trend) && Buy_Trend && f0_13(G_magic_412) == 0 && f0_1(1) == -2) G_ticket_408 = OrderSend(Symbol(), OP_BUY, Fixed_Lot, Ask, 3, Ask - SL * Gd_376, 0, Gs_428 + 0, G_magic_412, 0, White);
      if ((!Close_Sell_Trend) && Sell_Trend && f0_13(G_magic_416) == 0 && f0_1(1) == 2) G_ticket_408 = OrderSend(Symbol(), OP_SELL, Fixed_Lot, Bid, 3, Bid + SL * Gd_376, 0, Gs_436 + 0, G_magic_416, 0, Aqua);
      if ((!Close_Buy_Counter) && Buy_Counter && f0_13(G_magic_420) == 0 && f0_1(-1) == -2) G_ticket_408 = OrderSend(Symbol(), OP_BUY,Fixed_Lot, Ask, 3, Ask - SL * Gd_376, 0, Gs_444 + 0, G_magic_420, 0, Blue);
      if ((!Close_Sell_Counter) && Sell_Counter && f0_13(G_magic_424) == 0 && f0_1(-1) == 2) G_ticket_408 = OrderSend(Symbol(), OP_SELL, Fixed_Lot, Bid, 3, Bid + SL * Gd_376, 0, Gs_452 + 0, G_magic_424, 0, Red);
   }
   return (0);
}
...
void f0_8(int A_magic_0, string As_4) {
   ...
   if (Li_12 > 0 && Li_12 < Level_Max) {
      ...
      if (cmd_16 == OP_BUY && Ask <= Ld_40) G_ticket_408 = OrderSend(Symbol(), OP_BUY,Fixed_Lot, Ask, 3, Ask - SL * Gd_376, 0, As_4 + Li_12, A_magic_0, 0, Green);
      Ld_40 = order_open_price_20 + Range * Gd_376;
      if (cmd_16 == OP_SELL && Bid >= Ld_40) G_ticket_408 = OrderSend(Symbol(), OP_SELL, Fixed_Lot, Bid, 3, Bid + SL * Gd_376, 0, As_4 + Li_12, A_magic_0, 0, Yellow);
   }
}
