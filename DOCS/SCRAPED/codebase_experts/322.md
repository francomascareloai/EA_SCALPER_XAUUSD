# MQL5 Wizard - Trade Signals Based on Morning/Evening Stars + CCI - expert for MetaTrader 5

Source: https://www.mql5.com/en/code/322
...
Interesting script?  
So post a [link](/en/code/322) to it -  
...
[Русский](/ru/code/322) [中文](/zh/code/322) [Español](/es/code/322) [Deutsch](/de/code/322) [日本語](/ja/code/322) [Português](/pt/code/322) [한국어](/ko/code/322) [Français](/fr/code/322) [Italiano](/it/code/322) [Türkçe](/tr/code/322)
...
:   \MQL5\Include\Expert\Signal\MySignals\
    ...
    [acandlepatterns.mqh](/en/code/download/322/acandlepatterns.mqh "acandlepatterns.mqh")
    (20.34 KB)
    [view](# "view")

    [acms\_es\_cci.mqh](/en/code/download/322/acms_es_cci.mqh "acms_es_cci.mqh")
    (7.97 KB)
    [view](# "view")

    [expert\_ams\_es\_cci.mq5](/en/code/download/322/expert_ams_es_cci.mq5 "expert_ams_es_cci.mq5")
    (6.63 KB)
    [view](# "view")

    [Download as ZIP](/en/code/download/322.zip "Download all attachments in the single ZIP archive") [How to download code from MetaEditor](https://www.metatrader5.com/en/metaeditor/help/workspace/toolbox#codebase)
...
Here we will consider the signals, based on "Morning Star/Evening Star" (Morning Doji Star/Evening Doji Star) reversal candlestick patterns, confirmed by [CCI](https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci "https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci") indicator. The module of trade signals is based on the [CCandlePattern](/en/code/291) class, it's simple example of its use for creation of trade signals with candlestick patterns.
...
![Fig. 1. "Morning Star" and "Morning Doji Star" candlestick patterns](https://c.mql5.com/18/2/morning_stars_en.png "Fig. 1. \"Morning Star\" and \"Morning Doji Star\" candlestick patterns")
...
![Fig. 2. "Evening Star" and "Evening Doji Star" candlestick patterns](https://c.mql5.com/18/2/evening_stars_en.png "Figure 2. \"Evening Star\" and \"Evening Doji Star\" candlestick patterns")
...
![Fig. 3. The "Evening Star" pattern, confirmed by CCI indicator](https://c.mql5.com/18/2/Image_MS_ES_CCI__1.png "Fig. 3. The \"Evening Star\" pattern, confirmed by CCI indicator")

Fig. 3. The "Evening Star" pattern, confirmed by CCI indicator

  

* int CMS\_ES\_CCI::LongCondition() - checks conditions to open long position (returns 80) and close of the short position (returns 40);
* int CMS\_ES\_CCI::ShortCondition() - checks conditions to open short position (returns 80) and close of the long position (returns 40).

  

**2.1. Open long position/Close short position**

1. The formation of "Morning Star" pattern must be confirmed by [CCI](https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci "https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci") indicator: CCI(1)<-50 (the value of the CCI of the last completed bar must be less than -50).
...
![Fig. 4. Creating Expert Advisor using MQL5 Wizard](https://c.mql5.com/18/2/MQL5_Wizard_step_1__32.png "Fig. 4. Creating Expert Advisor using MQL5 Wizard")

Fig. 4. Creating Expert Advisor using MQL5 Wizard

Let's specify the name of the Expert Advisor:

![Fig. 5. General properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_2_MSES_CCI.png "Fig. 5. General properties of the Expert Advisor")

Fig. 5. General properties of the Expert Advisor

After that we need to select the modules of trade signals used.

![Fig. 6. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3__32.png "Fig. 6. Signal properties of the Expert Advisor")

Fig. 6. Signal properties of the Expert Advisor

In our case we use only one module of trade signals.

Adding the "**Signals based on Morning/Evening Stars confirmed by CCI**" module of trading signals:

![Fig. 7. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3_2_MSES_CCI.png "Fig. 7. Signal properties of the Expert Advisor")

Fig. 7. Signal properties of the Expert Advisor

Module of trade signals added:

![Fig. 8. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3_3_MSES_CCI.png "Fig. 8. Signal properties of the Expert Advisor")
...
![Fig. 9. Trailing properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_4__33.png "Fig. 9. Trailing properties of the Expert Advisor")
...
![Fig. 10. Money management properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_5__33.png "Fig. 10. Money management properties of the Expert Advisor")

Fig. 10. Money management properties of the Expert Advisor

By pressing the "Finish" button, we will get the code of the generated Expert Advisor, located in Expert\_AMS\_ES\_CCI.mq5, it will be saved in terminal\_data\_folder\MQL5\Experts\.
...
Let's consider backtesting of the Expert Advisor on historical data (EURUSD H1, testing period: 2009.01.01-2011.03.16, PeriodCCI=25, MA\_period=5).
...
![Fig. 11. Testing results of the Expert Advisor, based on Morning/Evening Stars + CCI](https://c.mql5.com/18/2/MSES_CCI_Test_Results.png "Fig. 11. Testing results of the Expert Advisor, based on Morning/Evening Stars + CCI")
...
The code of the Expert Advisor, created by MQL5 Wizard is attached in expert\_ams\_es\_cci.mq5.

Translated from Russian by MetaQuotes Ltd.   
Original code: [https://www.mql5.com/ru/code/322](/ru/code/322)

**Last comments |
[Go to discussion](/en/forum/3526)**
(3)
...
|
26 May 2011 at 01:42

**Automated-Trading:**  

[MQL5 Wizard - Trade Signals Based on Morning/Evening Stars + CCI](/en/code/322):

Author: [MetaQuotes Software Corp.](https://www.mql5.com/en/users/MetaQuotes "https://www.mql5.com/en/users/MetaQuotes")

HI , i m new in this , i ve tried to save this but i m not sure if i put this in the right folders can you help me with this , please?

thanks

![Guardian_Angel](https://c.mql5.com/avatar/avatar_na2.png "Guardian_Angel")

**[Guardian\_Angel](/en/users/guardian_angel)**
|
26 Oct 2014 at 21:40

I'm again with the same request, Could you make an [arrow indicator](https://www.mql5.com/en/articles/1699 "Article: Drawing arrow indicators using CCanvas class ") according to the same rules?))))))

![canoexu](https://c.mql5.com/avatar/avatar_na2.png "canoexu")

**[canoexu](/en/users/canoexu)**
|
14 Jan 2023 at 14:04

**Automated-Trading:**  

[MQL5 Wizard - Trading Signals based on Morning Star / Twilight Star patterns + CCI](/en/code/322).

Author: [MetaQuotes Software Corp.](/en/users/MetaQuotes)

2023.01.14 21:04:21.597 Tester optimisation by "Custom max" criterion not started, no OnTester function in "MQL5\Experts\Experts\_AMS \_ES\_CCI.ex5" WHY?

![Demo_BitmapOffset (OBJPROP_XOFFSET and OBJPROP_YOFFSET)](https://c.mql5.com/i/code/script.png)
[Demo\_BitmapOffset (OBJPROP\_XOFFSET and OBJPROP\_YOFFSET)](/en/code/325)
...
![MQL5 Wizard - Trade Signals Based on Morning/Evening Stars + RSI](https://c.mql5.com/i/code/expert.png)
[MQL5 Wizard - Trade Signals Based on Morning/Evening Stars + RSI](/en/code/324)
