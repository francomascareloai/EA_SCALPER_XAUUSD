...
Source: https://www.mql5.com/en/code/20641
...
Interesting script?  
So post a [link](/en/code/20641) to it -  
...
Updated:
:   3 February 2022, 11:17
:   [Binary Option Symbol.mq4](/en/code/download/20641/binary_option_symbol.mq4 "Binary Option Symbol.mq4")
    (2.04 KB)
    [view](# "view")

    [Download as ZIP](/en/code/download/20641.zip "Download all attachments in the single ZIP archive") [How to download code from MetaEditor](https://www.metatrader5.com/en/metaeditor/help/workspace/toolbox#codebase)
...
In the attached code, we use  MODE\_PROFITCALCMODE to detect if a symbol is binary Option or not.
...
**[Go to discussion](/en/forum/384308)**
