# MQL5 Wizard - Trade Signals Based on Bullish Harami/Bearish Harami + CCI - expert for MetaTrader 5

Source: https://www.mql5.com/en/code/311
...
Interesting script?  
So post a [link](/en/code/311) to it -  
...
[Русский](/ru/code/311) [中文](/zh/code/311) [Español](/es/code/311) [Deutsch](/de/code/311) [日本語](/ja/code/311) [Português](/pt/code/311) [한국어](/ko/code/311) [Français](/fr/code/311) [Italiano](/it/code/311) [Türkçe](/tr/code/311)
...
:   \MQL5\Include\Expert\Signal\MySignals\
    ...
    [acandlepatterns.mqh](/en/code/download/311/acandlepatterns.mqh "acandlepatterns.mqh")
    (20.34 KB)
    [view](# "view")

    [acbh\_bh\_cci.mqh](/en/code/download/311/acbh_bh_cci.mqh "acbh_bh_cci.mqh")
    (7.98 KB)
    [view](# "view")

    [expert\_abh\_bh\_cci.mq5](/en/code/download/311/expert_abh_bh_cci.mq5 "expert_abh_bh_cci.mq5")
    (6.63 KB)
    [view](# "view")

    [Download as ZIP](/en/code/download/311.zip "Download all attachments in the single ZIP archive") [How to download code from MetaEditor](https://www.metatrader5.com/en/metaeditor/help/workspace/toolbox#codebase)
...
The Bullish Harami reversal pattern forms in downward trend when large candlestick is followed by a smaller candlestick whose body is located within the vertical range of the larger body. This pattern indicates that the falling trend (downtrend) may be reversing, it signals that it's a good time to enter into a long position. The second candlestick is opened with a gap up. The smaller the second (white) candlestick, the more likely the reversal.

![Bullish Harami reversal pattern](https://c.mql5.com/18/2/bullish_harami_en__2.png "Bullish Harami reversal pattern")
...
![Bearish Harami reversal pattern](https://c.mql5.com/18/2/bearish_harami_en__2.png "Bearish Harami reversal pattern")
...
![Figure 3. "Bullish Harami" pattern, confirmed by CCI indicator](https://c.mql5.com/18/2/Image_BH_BH_CCI__1.png "Fig. 3. \"Bullish Harami\" pattern, confirmed by CCI indicator")

Fig. 3. "Bullish Harami" pattern, confirmed by CCI indicator

* int CBH\_BH\_CCI::LongCondition() - checks conditions to open long position (returns 80) and close of the short position (returns 40);
* int CBH\_BH\_CCI::ShortCondition() - checks conditions to open short position (returns 80) and close of the long position (returns 40).

  

**2.1. Open long position/Close short position**

1. The formation of "Bullish Harami" pattern must be confirmed by [CCI](https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci "https://www.metatrader5.com/en/terminal/help/indicators/oscillators/cci") indicator: CCI(1)<-50 (the value of the CCI of the last completed bar must be less than -50).
...
![Fig. 4. Creating Expert Advisor using MQL5 Wizard](https://c.mql5.com/18/2/MQL5_Wizard_step_1__10.png "Fig. 4. Creating Expert Advisor using MQL5 Wizard")

Fig. 4. Creating Expert Advisor using MQL5 Wizard

Let's specify the name of the Expert Advisor:

![Fig. 5. General properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_2_BHBH_CCI.png "Fig. 5. General properties of the Expert Advisor")

Fig. 5. General properties of the Expert Advisor

After that we need to select the modules of trade signals used.

![Fig. 6. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3__10.png "Fig. 6. Signal properties of the Expert Advisor")

Fig. 6. Signal properties of the Expert Advisor

In our case we use only one module of trade signals.

Adding the "**Signals based on Bullish Harami/Bearish Harami confirmed by CCI**" module of trading signals:

![Fig. 7. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3_2_HHM_CCI.png "Fig. 7. Signal properties of the Expert Advisor")

Fig. 7. Signal properties of the Expert Advisor

Module of trade signals added:

![Fig. 8. Signal properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_3_3_HHM_CCI.png "Fig. 8. Signal properties of the Expert Advisor")
...
![Fig. 9. Trailing properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_4__11.png "Fig. 9. Trailing properties of the Expert Advisor")
...
![Fig. 10. Money management properties of the Expert Advisor](https://c.mql5.com/18/2/MQL5_Wizard_step_5__11.png "Fig. 10. Money management properties of the Expert Advisor")

Fig. 10. Money management properties of the Expert Advisor

By pressing the "Finish" button, we will get the code of the generated Expert Advisor, located in Expert\_ABH\_BH\_CCI.mq5, it will be saved in terminal\_data\_folder\MQL5\Experts\.
...
Let's consider backtesting of the Expert Advisor on historical data (EURUSD H1, testing period: 2010.01.01-2011.03.16, PeriodCCI=11, MA\_period=5).
...
![Fig. 11. Testing results of the Expert Advisor, based on Bullish Harami/Bearish Harami + CCI](https://c.mql5.com/18/2/BHBH_CCI_Test_Results.png "Fig. 11. Testing results of the Expert Advisor, based on Bullish Harami/Bearish Harami + CCI")
...
The code of the Expert Advisor, created by MQL5 Wizard is attached in expert\_abh\_bh\_cci.mq5.

Translated from Russian by MetaQuotes Ltd.   
Original code: [https://www.mql5.com/ru/code/311](/ru/code/311)

**[Go to discussion](/en/forum/3427)**
