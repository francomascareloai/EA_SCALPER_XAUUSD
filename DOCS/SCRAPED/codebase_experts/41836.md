...
Source: https://www.mql5.com/en/code/41836
...
Interesting script?  
So post a [link](/en/code/41836) to it -  
...
Published:
:   21 December 2022, 03:16

Updated:
:   10 February 2023, 13:17
:   \MQL5\Scripts\Introsort\

    [Introsort.mqh](/en/code/download/41836/introsort.mqh "Introsort.mqh")
    (16.68 KB)
    [view](# "view")

    [Introsort\_benchmark.mq5](/en/code/download/41836/introsort_benchmark.mq5 "Introsort_benchmark.mq5")
    (3.23 KB)
    [view](# "view")

    [sort\_string\_array.mq5](/en/code/download/41836/sort_string_array.mq5 "sort_string_array.mq5")
    (2.07 KB)
    [view](# "view")

    [sort\_structure\_array.mq5](/en/code/download/41836/sort_structure_array.mq5 "sort_structure_array.mq5")
    (3.9 KB)
    [view](# "view")

    [Download as ZIP](/en/code/download/41836.zip "Download all attachments in the single ZIP archive") [How to download code from MetaEditor](https://www.metatrader5.com/en/metaeditor/help/workspace/toolbox#codebase)
...
**Last comments |
[Go to discussion](/en/forum/438406)**
(1)
...
**[amrali](/en/users/amrali)**
|
25 Dec 2022 at 23:51

**Update 25 Dec, 2022**

The Less() function changed to generic to enable [sorting arrays](https://www.mql5.com/en/docs/array/arraysort "MQL5 documentation: ArraySort function") of simple types in descending order.
...
![Smooth Algorithms - Corrected/Modified](https://c.mql5.com/i/code/library.png)
[Smooth Algorithms - Corrected/Modified](/en/code/41854)
