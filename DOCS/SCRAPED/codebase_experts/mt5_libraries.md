...
Source: https://www.mql5.com/en/code/mt5/libraries
...
[Comment](/en/code/48689 "Comment")

A simple comment.

[ConvertServerTime](/en/code/65102 "ConvertServerTime")

Function to convert server time from one broker's time zone to another.

[StopLoss trailing classes library for MQL5](/en/code/63926 "StopLoss trailing classes library for MQL5")
...
[MT5 to Telegram - Professional Trading Notifications Library](/en/code/63585 "MT5 to Telegram - Professional Trading Notifications Library")
...
[MT5 to Telegram Professional Library](/en/code/63587 "MT5 to Telegram Professional Library")
...
[Logify - Library for log management](/en/code/59821 "Logify - Library for log management")
...
[A powerful and feature-rich JSON library for MQL5, designed to bring a modern development experience similar to Python/JS](/en/code/62735 "A powerful and feature-rich JSON library for MQL5, designed to bring a modern development experience similar to Python/JS")

A powerful and feature-rich JSON library for MQL5, designed to bring a modern development experience similar to Python/JS

[Promise](/en/code/54412 "Promise")

Interface for implementing asynchronous execution of algorithms

[EAToMath](/en/code/61283 "EAToMath")

Testing on history in the MT5 tester maths mode.

[TicksShort](/en/code/61126 "TicksShort")

A short format for storing ticks.

[CBitBuffer Class - Data Serialization in MQL5](/en/code/61728 "CBitBuffer Class - Data Serialization in MQL5")

A class for reading and writing individual bits or bit sequences to and from a buffer.

[GZIP - Decode](/en/code/59309 "GZIP - Decode")

Unpack GZIP archives from \*.gz files or responses from sites compressed with this format.

[Telegram To MT5 Copier](/en/code/56646 "Telegram To MT5 Copier")
...
[Trade Classes in Python - CTade, CSymbol, CPositionInfo, etc.](/en/code/59808 "Trade Classes in Python - CTade, CSymbol, CPositionInfo, etc.")

MQL5-Like Trade Classes in Python for MetaTrader 5 Python

[CTsLogger is a simple and flexible logging system](/en/code/58105 "CTsLogger is a simple and flexible logging system")

Logger with the ability to log individual modules or code sections

[CTsLogger - Simple and Flexible Logger](/en/code/58124 "CTsLogger - Simple and Flexible Logger")
...
[MultiTester](/en/code/26132 "MultiTester")

Multiple runs/optimisations in Tester.

[Calendar](/en/code/32430 "Calendar")

Calendar - fundamental analysis on history and real-time.

[SingleTesterCache](/en/code/27611 "SingleTesterCache")

Tester's single pass data.

[Introsort (Introspective sort) using Function Pointers](/en/code/57233 "Introsort (Introspective sort) using Function Pointers")
...
[JSON](/en/code/53107 "JSON")

Serialization and deserialization of the JSON format

[Timer](/en/code/53101 "Timer")

Callback interface for timer

[Telegram integration made easy](/en/code/56583 "Telegram integration made easy")
...
[Print massive information (PrintXYZ) from the terminal](/en/code/56055 "Print massive information (PrintXYZ) from the terminal")

PrintXYZ() library to print massive information from the terminal.

[Calendar-Based Backtesting: an Event-Driven Trading EA](/en/code/55630 "Calendar-Based Backtesting: an Event-Driven Trading EA")

This Script & EA enables coders to backtest their news based strategies which use the MQL5 Calendar.

[High-Performance Time Functions (TimeUtils)](/en/code/53970 "High-Performance Time Functions (TimeUtils)")

High-performmance functions for dealing with time.

[MT4 to MT5 Convertor (MT5Compat.mqh)](/en/code/53547 "MT4 to MT5 Convertor (MT5Compat.mqh)")
...
[Comment](/en/code/53499 "Comment")

A simple replacement for a comment.
Works in the tester 50 times faster than the standard function.

[Push Notification for Opened / Closed Trades (Netting)](/en/code/52899 "Push Notification for Opened / Closed Trades (Netting)")
...
[Simplest Logger class for MetaTrader 5](/en/code/52741 "Simplest Logger class for MetaTrader 5")
...
[Logging V2 for both MQL4 and MQL5](/en/code/52298 "Logging V2 for both MQL4 and MQL5")
...
[Balance\_Reset](/en/code/52163 "Balance_Reset")
...
[Logging Class for both MQL4 and MQL5](/en/code/51817 "Logging Class for both MQL4 and MQL5")

The CDebugLogger class is a flexible and comprehensive logging utility designed for use in MQL4/5 environments. It allows developers to log messages at various levels of importance (INFO, WARNING, ERROR, DEBUG) with options to include timestamps, function signatures, file names, and line numbers in the log entries. The class supports logging to both the console and files, with the ability to save logs in a common folder and in CSV format. Additionally, it offers functionality to silence logs based on specific keywords, ensuring that sensitive information is not logged. This class is ideal for developers looking to implement robust logging mechanisms in their MQL4/5 applications, with customizable features that cater to a wide range of debugging and monitoring needs.

[Easy to use Hedging Class for MQL5 by Peter Mueller](/en/code/50358 "Easy to use Hedging Class for MQL5 by Peter Mueller")

This EA is a demonstration of how you can implement your own Hedging strategy with the help of the include file.

[Basic Library to Create Volume Profiles](/en/code/49718 "Basic Library to Create Volume Profiles")

Basic library to create Volume Profiles on chart.

[Basic GridManager Library](/en/code/49186 "Basic GridManager Library")

This is a basic library to create and manage grids.

[Local Timezones and Local Session Hours](/en/code/48419 "Local Timezones and Local Session Hours")
...
[Class For Working With Databases In A Simplified Manner](/en/code/48362 "Class For Working With Databases In A Simplified Manner")
